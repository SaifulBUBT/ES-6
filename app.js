...
///////// Moduling 
import {sub, addi, car} from './math';
console.log(sub(30,5));
console.log(addi(7, 7))

let{c_name, color, c_price} = car;
 console.log(`car name :${c_name}; Price: ${c_price};`);


 /////////// class 
import Human from './human';
let h1 = new Human('Robin', 'Mamal','2');
h1.print();
let h2 = new Human('Saiful islam', 'mammals','2');
h2.print();
